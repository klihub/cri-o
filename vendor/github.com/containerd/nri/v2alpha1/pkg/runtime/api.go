...
// aliased symbols from api.proto
// nolint
type (
...
const (
	...
	ContainerStateExited  = ContainerState_CONTAINER_STOPPED

	SELinuxRelabel = api.SELinuxRelabel
)

// aliased symbols from api/optional.go
// nolint
type (
...
// aliased symbols from api/types.go
// nolint
var (
