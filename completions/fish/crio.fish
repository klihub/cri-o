...
complete -c crio -n '__fish_crio_no_subcommand' -f -l nri-socket-path -r -d 'Socket to create for externally started NRI plugins to connect to. (default: "/var/run/nri.sock")'
