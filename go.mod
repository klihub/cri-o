...
replace (
	// Temporarily divert repo for updated/extended NRI (pending PR not merged).
	github.com/containerd/nri => github.com/klihub/nri v0.0.0-20220912062812-c1cf5a4d5b84
