...
require (
	...
	github.com/container-orchestrated-devices/container-device-interface v0.0.0-20220120134846-44b2a8591ac6
...
replace (
	github.com/container-orchestrated-devices/container-device-interface => github.com/klihub/container-device-interface v0.0.0-20220127153731-10f8f04a3ddc
